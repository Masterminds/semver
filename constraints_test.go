...
func TestConstraintCheck(t *testing.T) {
	tests := []struct {
		...
		{">=1.1", "1.1.0", true},
		{">=1.1", "0.0.9", false},
		{">=1.0.0", "1.1.0-pre", true},
		{">=1.1.0", "1.1.0-pre", false},
		{"<=1.1.0", "1.1.0-pre", true},
		{"<=1.1", "0.1.0", true},
		{"<=1.1", "1.1.0", true},
		{"<=1.1", "1.1.1", false},
		{">0", "0", false},
...
func TestConstraintsValidate(t *testing.T) {
	...
	tests2 := []struct {
		...
		{">=1.0.0", "1.1.0-pre", "1.1.0-pre is greater than 1.0.0"},
		{">=1.1.0", "1.1.0-pre", "1.1.0-pre is less than 1.1.0"},
		{"<=1.1.0", "1.1.0-pre", "1.1.0-pre is less than 1.1.0"},
